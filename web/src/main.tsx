...
const messages = {
  en: {
    ...
    localApiBlocked: "The hosted UI needs browser permission to reach the local API at 127.0.0.1:8787. Open the local workbench to avoid this permission, or allow Apps on device / Loopback Network access in site settings.",
  ...
  zh: {
    ...
    localApiBlocked: "线上 UI 访问本机 127.0.0.1:8787 API 需要浏览器本机网络权限。建议打开本地工作台；若继续使用线上页，请在站点权限中允许 Apps on device / Loopback Network / Local Network。",
